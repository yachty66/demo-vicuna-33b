...
# Banana.dev Vicuna-33B starter template

This is a Vicuna-33B starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/bananaml/demo-vicuna-33b/fork) repository to your own Github account.
...
Build the model as a Docker image. You can change the `banana-vicuna-33b` part to anything.

```sh
docker build -t banana-vicuna-33b .
```

Run the Potassium server

```sh
docker run --publish 8000:8000 -it banana-vicuna-33b
```
